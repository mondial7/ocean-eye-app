...
* Router class
*
* Evaluate uri and load the right controller
* with a switch based on path segments
*/
class DumpRouter {
	...
	public static function route($path_segment, $route_data = null) {
		...
		// Store the new route
		static::$routes[$path_segment] = $route_data;
	...
	public static function render($uri, $controllers_dir = null) {
		...
		require_once static::loadController($uri, $controllers_dir);
